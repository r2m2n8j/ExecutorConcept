...
- If Hashmap contains 10 elements and hash code is constant, then all elements goes to same bucket, then size method is hashmap gives a size of 1 to 10.
- For above scenario learn internal implementation and hashmap working.
- What is concurrent map? synchronized hashmap? And concurrent hashmap? And internal working of it.
- What is Hash table?
- Why Hash collision occur in HashMap explain it briefly?
- How will you retrieve value if two keys have the same HashCode?
- If hashcode() method of an object always return 0 then what happen
- Hashcode equal method override(If equals method not override than what happened)
